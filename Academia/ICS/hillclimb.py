...
#calculates the squared difference b/w two points
...
Initialize the increment parameter, a starting point to begin on a hill climb to find the maxima.
Initialize x & y co-ordinates.
"""

increment = input("Enter Increment Value : ")

input_string = input("Enter Starting Point")
startingPoint = input_string.split()
...
input_string = input("Enter Point-1 string separated by space ")
point1 = input_string.split()
point1[0] = int(point1[0])
point1[1] = int(point1[1])

input_string = input("Enter Point-2 string separated by space ")
point2 = input_string.split()
point2[0] = int(point2[0])
point2[1] = int(point2[1])

input_string = input("Enter Point-3 string separated by space ")
point3 = input_string.split()
point3[0] = int(point3[0])
point3[1] = int(point3[1])

input_string = input("Enter Point-4 string separated by space ")
point4 = input_string.split()
